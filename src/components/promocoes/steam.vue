...
<script>
  ...
  export default {
    ...
    created() {
      this.loading = true
      axios
        .get("https://promogames-steam.herokuapp.com/promocoes/1")
        .then(response => {
    ...
    methods: {
      ...
      this.loading = true
      axios
        .get(`https://promogames-steam.herokuapp.com/promocoes/${page}`)
        .then(response => {
